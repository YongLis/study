...
public class StringUtil {
	 ...
	 */
	public static boolean localdateLtDate(String date) throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static boolean localdateLtDate2(String date) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
		Date date1 = sdf.parse(date);
		Date now = sdf.parse(sdf.format(new Date()));
	 ...
	 * @throws ParseException
	 */
	public static Long getTimeHMillisDate(String strdate) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
	 ...
	 * @throws ParseException
	 */
	public static Long getTimeMillisDate(String strdate) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
		Date date = sdf.parse(strdate);
